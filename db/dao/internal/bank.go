...
// BankDao is the data access object for table w_bank.
type BankDao struct {
...
// BankColumns defines and stores column names for table w_bank.
...
// bankColumns holds the columns for table w_bank.
